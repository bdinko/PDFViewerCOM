...
- **Annotations** — Highlights, sticky notes, freehand drawing with shapes, colors, select/move, undo, import/export (JSON). Zoom-responsive: all annotation types reposition and resize proportionally with the zoom level.
