...
namespace PDFViewerCOM
{
    ...
    public interface IPDFViewerCOMControlEvents
    {
        ...
        /// <summary>
        /// Fired when a PDF document is loaded and fully rendered. All page elements exist —
        /// safe to call ImportAnnotationsData() immediately.
        /// Read PDFViewerCOM_Ctrl{'LoadType'} to determine how the document was loaded:
        /// 'base64', 'file', or 'url'. IMPORTANT: Guard ImportAnnotationsData() with LoadType —
        /// only restore annotations when LoadType = 'base64', otherwise annotations from a
        /// previous load will bleed into the new document.
        /// </summary>
