...
namespace PDFViewerCOM
{
    ...
    public interface IPDFViewerCOMControl
    {
        ...
        /// <summary>
        /// Gets how the current document was loaded: 'base64' (LoadBase64/LoadBase64Data),
        /// 'file' (LoadFile/LoadFilePath), or 'url' (LoadUrl).
        /// Use in Clarion to guard ImportAnnotationsData() calls — only restore
        /// annotations when LoadType = 'base64', so disk/URL loads start clean.
        /// In Clarion: lType = PDFViewerCOM_Ctrl{'LoadType'}
        /// </summary>
        [DispId(106)]
        string LoadType { get; }
